...
import com.unifoxdigital.tracemyfish.context.PagerMain;
        ...
        NavigationView.OnNavigationItemSelectedListener,TabLayout.OnTabSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Aquaculture"));
        tabLayout.addTab(tabLayout.newTab().setText("Agriculture"));
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        {
            Toast.makeText(getApplicationContext(),"FAQ Menu",Toast.LENGTH_SHORT).show();
        }
